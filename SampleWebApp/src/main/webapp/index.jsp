<html>
  ...
  <body bgcolor="#00FF00">
    <h1>Hello from RealCloud & Devops Expert Edo Boy </h1>
    <!--Form declaration. Must have an action attribute -->
        <form action="C:/JonnyJava/FirstJava.html/profile.html" method="post">
            <p>if life was the thing that money could buy, the rich would live and the poor could die. </p> <!--This control is for mutplie line comment-->
